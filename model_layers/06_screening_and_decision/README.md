# 06 Screening And Decision

Goldeneye benchmark cases, NSTA batch screening outputs, and pre-LCA decision files.
...
| `refurbishment_work_scope_model.md` | Plain-language explanation of the quantified work-scope table. |
